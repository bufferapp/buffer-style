...
var BufferAvatar = React.createClass({displayName: "BufferAvatar",
  render: function() {
    ...
    var image = React.createElement("img", {className: className, src: imgsrc})
    if(this.props.href) {
      return (React.createElement("a", {className: className, href: href}, image))
    }
    else {
      return image;
    }
...
React.render(
  React.createElement(BufferAvatar, {type: 'small', imgsrc: 'https://buffer.com/images/team/sunil.png'}), document.getElementById('avatarsmall')
);

React.render(
  React.createElement(BufferAvatar, {type: 'medium', imgsrc: 'https://buffer.com/images/team/sunil.png'}), document.getElementById('avatarmedium')
);

React.render(
  React.createElement(BufferAvatar, {type: 'large', imgsrc: 'https://buffer.com/images/team/sunil.png'}), document.getElementById('avatarlarge')
);



},{"./BufferAvatar":156,"react":155}]},{},[157]);
